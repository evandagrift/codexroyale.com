...
namespace ClashFeeder.Models
{
    ...
    {
        public string Tag { get; set; } //PlayerSnapshot tag fetched from json
        public string Name { get; set; } //PlayerSnapshot name fetched from json
        public int TrophyChange { get; set; }//how many trophies PlayerSnapshot gained or lost as result of game

        public int StartingTrophies { get; set; } //PlayerSnapshot's starting trophies fetched from json
